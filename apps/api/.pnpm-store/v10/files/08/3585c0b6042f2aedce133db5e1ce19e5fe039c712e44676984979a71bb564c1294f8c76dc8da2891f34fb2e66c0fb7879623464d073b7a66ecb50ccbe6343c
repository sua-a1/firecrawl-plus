...
exports.retryDeletes = exports.getRecordIds = exports.assertWithRetries = exports.waitUntilRecordsReady = exports.waitUntilReady = exports.sleep = exports.randomIndexName = exports.generateMetadata = exports.generateSparseValues = exports.generateValues = exports.generateRecords = exports.randomString = exports.globalNamespaceOne = exports.diffPrefix = exports.prefix = void 0;
...
const randomIndexName = (testName) => {
    return `${process.env.TEST_ENV}-${testName}-${(0, exports.randomString)(8)}`
        .toLowerCase()
        .slice(0, 45);
};
...
const assertWithRetries = async (asyncFn, assertionsFn, maxRetries = 5, delay = 2000) => {
    let attempts = 0;
